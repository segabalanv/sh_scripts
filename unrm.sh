...
#   results ordered by timestamp and lets the user specify which one
#   to restore.
...
# If given no arguments, just show a listing of te deleted files.
if [ $# -eq 0 ] ; then
