...
#   duartion of loan (years), calculates the per-payment amount
...
. library.sh   # Starting by sourcing the script library.
...
cat << EOF
A $L-year loan at $I% interest with a principal with a principal amount of $(nicenumber $P 1 )
